...
SECTION_DEBUG: Section = Section(
    [
        ...
        ConfigurationNameValue(name=PropertyName('scheduleSuperNova'),                        defaultValue='False'),
        ConfigurationNameValue(name=PropertyName('scheduleTractorBeam'),                      defaultValue='False'),
        ConfigurationNameValue(name=PropertyName('scheduleCommanderAttacksBase'),             defaultValue='False'),
...
class GameSettingsV2(ConfigurationProperties, metaclass=SingletonV3):
    """
