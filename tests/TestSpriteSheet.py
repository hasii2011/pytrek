...
class TestSpriteSheet(Window):
    ...
    def on_draw(self):
        ...
        """
        start_render()
        draw_text(EXPLOSION_TITLE, TITLE_X, TITLE_Y, color=TestSpriteSheet.ETX_COLOR, font_size=16)
    ...
    def _drawEnterpriseTorpedoExplosionTitle(self):
        ...
        draw_text(msg, etxPoint.x - TITLE_TORPEDO_X_OFFSET, etxPoint.y - TITLE_TORPEDO_Y_OFFSET, color=TestSpriteSheet.ETX_COLOR)
    ...
    def _drawKlingonTorpedoExplosionTitle(self):
        ...
        draw_text(msg, ktxPoint.x - TITLE_TORPEDO_X_OFFSET, ktxPoint.y - TITLE_TORPEDO_Y_OFFSET, color=TestSpriteSheet.ETX_COLOR)
    ...
    def _drawCommanderTorpedoExplosionTitle(self):
        ...
        draw_text(msg, ctxPoint.x - TITLE_TORPEDO_X_OFFSET, ctxPoint.y - TITLE_TORPEDO_Y_OFFSET, color=TestSpriteSheet.ETX_COLOR)
    ...
    def _drawSuperCommanderTorpedoExplosionTitle(self):
        ...
        draw_text(msg, stxPoint.x - TITLE_TORPEDO_X_OFFSET, stxPoint.y - TITLE_TORPEDO_Y_OFFSET, color=TestSpriteSheet.ETX_COLOR)

    def _drawPhaserFireTitle(self):

        pfPoint: ArcadePoint = self.phaserFirePoint
        msg: str = 'Phaser Fire Effect'
        draw_text(msg, pfPoint.x - 80, pfPoint.y - TITLE_TORPEDO_Y_OFFSET, color=TestSpriteSheet.ETX_COLOR)
